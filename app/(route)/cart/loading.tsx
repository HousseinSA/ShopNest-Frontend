        ...
        <div className="lg:col-span-7">
          ...
          <ul className="space-y-4">
            {skeletonItems.map((_, index) => (
              <li key={index} className="flex flex-col lg:flex-row border-b last:border-b-0 gap-x-4">
                <div className="relative h-24 w-full rounded-md overflow-hidden sm:h-48">
