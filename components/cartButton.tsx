...
const {items} = useCartState() 
  ...
  return (
    ...
    <div  className='ml-auto w-8 h-8 md:h-11 md:w-11'>
      <Button onClick={()=>route.push('/cart')}   className='relative bg-primary-mainColor rounded-full p-2 w-full h-full  disabled:cursor-not-allowed transition hover:bg-primary-hoverMain flex items-center text-white'>
